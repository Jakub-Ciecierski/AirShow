...
namespace
{
    ...
    void LoadCacheRecursive(FbxScene * pScene, FbxAnimLayer * pAnimLayer, const char * pFbxFileName, bool pSupportVBO)
    {
		...
		const FbxString testTexFileName = "C:/Users/Jakub/Documents/programming/airshow/AirShow/assets/Golden\ Eagle/FBX/GoldenEagle.tga";
        ...
        for (int lTextureIndex = 0; lTextureIndex < lTextureCount; ++lTextureIndex)
        {
            ...
            if (lFileTexture && !lFileTexture->GetUserDataPtr())
            {
				...
				const FbxString lFileName = testTexFileName;
